...
# Arguments
ASMFLAGS		= -Wall -c -mcpu=arm926ej-s -mthumb-interwork -O0 -lgcc -Wno-write-strings	

CCFLAGS		+= -Wall -mcpu=arm926ej-s -mthumb-interwork -O0 -lgcc -Wno-write-strings

LDFLAGS		+= -T $(FX3FWROOT)/common/fx3cpp.ld  -d \
