...
/*                                                                        */ 
/*  12-12-2005     William E. Lamie         Initial ARM9 RealView         */ 
/*                                            Support Version 5.0         */ 
/*  12-26-2007     William E. Lamie         Modified comment(s), changed  */ 
/*                                            "temp" to "tx_temp", and    */ 
...
/* KYS: Enabling IRQ nesting for USB 3.0 platform. */
...
#define TX_INTERRUPT_SAVE_AREA                  register unsigned int interrupt_save, tx_temp;

#ifdef  TX_ENABLE_FIQ_SUPPORT
#define TX_DISABLE                              __asm \
                                                { \
                                                    MRS  interrupt_save, CPSR; \
                                                    ORR  tx_temp, interrupt_save, 0xC0; \
                                                    MSR  CPSR_c, tx_temp \
                                                }
#else
#define TX_DISABLE                              __asm \
                                                { \
                                                    MRS  interrupt_save, CPSR; \
                                                    ORR  tx_temp, interrupt_save, 0x80; \
                                                    MSR  CPSR_c, tx_temp \
                                                }
#endif
