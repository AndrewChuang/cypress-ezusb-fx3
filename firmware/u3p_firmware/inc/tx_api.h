...
#ifdef CYU3P_TX_MEMPOOL_ALIGN_FIX
    /* Whether the block allocated should be aligned to the cache line size. */
    UINT                tx_block_pool_align_to_cacheline;
#endif
...
#ifdef CYU3P_TX_MEMPOOL_ALIGN_FIX
    UINT                tx_byte_pool_align_to_cacheline;
#endif
...
#ifdef CYU3P_TX_MEMPOOL_ALIGN_FIX
#define tx_block_pool_create(p,n,b,s,l,a)           _txe_block_pool_create(p,n,b,s,l,sizeof(TX_BLOCK_POOL),a)
#else
...
#ifdef CYU3P_TX_MEMPOOL_ALIGN_FIX
#define tx_byte_pool_create(p,n,s,l,a)              _txe_byte_pool_create(p,n,s,l,sizeof(TX_BYTE_POOL),a)
#else
