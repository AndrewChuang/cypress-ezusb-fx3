...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x4B,0x00,                      /* Length of this descriptor and all sub descriptors */
    ...
    /* Interface 0, Alt. Setting 0: One ISO IN endpoint with no data. */
    0x09,                           /* Descriptor size */
    ...
    0x06,                           /* Servicing interval for data transfers : 32 uFrames */

    /* Super speed endpoint companion descriptor. */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
    0,                              /* 1 packet per burst. */
    0,                              /* One burst per interval. */
    0x00,0x04,                      /* Bytes per interval : 0 */
