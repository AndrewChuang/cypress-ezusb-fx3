...
#define CY_FX_HOST_VBUS_ENABLE_VALUE    (CyFalse)/* GPIO value for driving VBUS. */
#define CY_FX_HOST_VBUS_DISABLE_VALUE   (CyTrue) /* GPIO value for disabling VBUS. */
...
/*#define CY_FX_MSC_ENABLE_WRITE_TEST     (1)*/ /* Enable this macro will cause data corruption on the
                                                   MSC device and will have to be formatted after competion
                                                   of the test. */
