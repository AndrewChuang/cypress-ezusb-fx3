        ...
        void)
{
     ...
     * to match this. (size + 0x0F) & ~0x0F will give this value. For 
     * super speed burst mode of operation, the buffers will be
    ...
    /* Multiply the buffer size with burst value and the multiplier
     * for performance improvement. */
    dmaCfg.size *= CY_FX_ISO_BURST * CY_FX_DMA_MULTIPLIER;
