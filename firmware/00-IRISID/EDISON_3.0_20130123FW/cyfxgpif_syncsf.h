 ...
 */
#define CY_SYNC_SLAVE_FIFO_2BIT_NUMBER_OF_STATES 6

/* Summary
   Mapping of user defined state names to state indices
 */
#define SYNC_SLAVE_FIFO_2BIT_RESET 0
#define SYNC_SLAVE_FIFO_2BIT_IDLE 1
#define SYNC_SLAVE_FIFO_2BIT_WRITE 2
#define SYNC_SLAVE_FIFO_2BIT_SHORT_PKT 3
#define SYNC_SLAVE_FIFO_2BIT_ZLP 4
#define SYNC_SLAVE_FIFO_2BIT_DSS_STATE 5
...
uint16_t Sync_Slave_Fifo_2Bit_CyFxGpifTransition[]  = {
    0x0000, 0x8888, 0x4444, 0x5555, 0x1F1F, 0x7777
};
...
CyU3PGpifWaveData Sync_Slave_Fifo_2Bit_CyFxGpifWavedata[]  = {
    ...
    {{0x1E700101,0x00020304,0x80000000},{0x5E702703,0x20000200,0xC0100000}},
    {{0x4E002702,0x20030202,0x80000000},{0x1E700101,0x00020304,0x80000000}},
    {{0x00000000,0x00000000,0x00000000},{0x00000000,0x00000000,0x00000000}},
    {{0x5E702703,0x20000200,0xC0100000},{0x3E738704,0x00000200,0xC0100000}}
};
