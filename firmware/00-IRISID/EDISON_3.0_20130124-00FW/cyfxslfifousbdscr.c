...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x53,0x00,//0x4E,0x00,//0x2C,0x00,                      /* Length of this descriptor and all sub descriptors */
 ...
 //   BURST_LEN-1,						/* Max no. of packets in a burst : 0: burst 1 packet at a time */
    ...
    /* Super speed endpoint companion descriptor for consumer EP2 */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
//    0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
    BURST_LEN-1,						/* Max no. of packets in a burst : 0: burst 1 packet at a time */
    ...
    /* Endpoint descriptor for consumer EP3 */
    0x07,                           /* Descriptor size */
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
    ...
    /* Super speed endpoint companion descriptor for consumer EP3 */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
 //  0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
   BURST_LEN-1,						/* Max no. of packets in a burst : 0: burst 1 packet at a time */
	...
	/* Endpoint descriptor for consumer EP4 */
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	...
	/* Super speed endpoint companion descriptor for consumer EP4 */
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
//	 0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
	BURST_LEN-1,						/* Max no. of packets in a burst : 0: burst 1 packet at a time */
	...
	/* Endpoint descriptor for consumer EP5 */
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	...
	/* Super speed endpoint companion descriptor for consumer EP5 */
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
//	  0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
	BURST_LEN-1,						/* Max no. of packets in a burst : 0: burst 1 packet at a time */
