...
#define CY_FX_PRODUCER_USB_SOCKET_1    CY_U3P_UIB_SOCKET_PROD_1    /* USB Socket 1 is producer */
#define CY_FX_PRODUCER_USB_SOCKET_2    CY_U3P_UIB_SOCKET_PROD_2    /* USB Socket 1 is producer */
#define CY_FX_PRODUCER_USB_SOCKET_3    CY_U3P_UIB_SOCKET_PROD_3    /* USB Socket 1 is producer */
#define CY_FX_PRODUCER_USB_SOCKET_4    CY_U3P_UIB_SOCKET_PROD_4    /* USB Socket 1 is producer */
#define CY_FX_PRODUCER_USB_SOCKET_5    CY_U3P_UIB_SOCKET_PROD_5    /* USB Socket 1 is producer */

#define CY_FX_CONSUMER_USB_SOCKET_1    CY_U3P_UIB_SOCKET_CONS_1    /* USB Socket 1 is consumer */
#define CY_FX_CONSUMER_USB_SOCKET_2    CY_U3P_UIB_SOCKET_CONS_2    /* USB Socket 1 is consumer */
#define CY_FX_CONSUMER_USB_SOCKET_3    CY_U3P_UIB_SOCKET_CONS_3    /* USB Socket 1 is consumer */
#define CY_FX_CONSUMER_USB_SOCKET_4    CY_U3P_UIB_SOCKET_CONS_4    /* USB Socket 1 is consumer */
#define CY_FX_CONSUMER_USB_SOCKET_5    CY_U3P_UIB_SOCKET_CONS_5    /* USB Socket 1 is consumer */

/* Used with FX3 Silicon. */
#define CY_FX_PRODUCER_PPORT_SOCKET    CY_U3P_PIB_SOCKET_0    /* P-port Socket 0 is producer */
#define CY_FX_PRODUCER_PPORT_SOCKET1    CY_U3P_PIB_SOCKET_1    /* P-port Socket 0 is producer */
#define CY_FX_PRODUCER_PPORT_SOCKET2    CY_U3P_PIB_SOCKET_2    /* P-port Socket 0 is producer */
#define CY_FX_PRODUCER_PPORT_SOCKET3    CY_U3P_PIB_SOCKET_3    /* P-port Socket 0 is producer */

#define CY_FX_CONSUMER_PPORT_SOCKET    CY_U3P_PIB_SOCKET_10    /* P-port Socket 3 is consumer */
#define CY_FX_CONSUMER_PPORT_SOCKET1    CY_U3P_PIB_SOCKET_11    /* P-port Socket 3 is consumer */
#define CY_FX_CONSUMER_PPORT_SOCKET2    CY_U3P_PIB_SOCKET_12    /* P-port Socket 3 is consumer */
#define CY_FX_CONSUMER_PPORT_SOCKET3    CY_U3P_PIB_SOCKET_13    /* P-port Socket 3 is consumer */
