...
----------------------------------------
  ...
  Files:
    ...
    * cyfxusbspidmamode.h  : Constant definitions for the USB SPI application.
    ...
    * cyfxusbspidmamode.c  : Main C source file that implements the USB SPI application
      example.
