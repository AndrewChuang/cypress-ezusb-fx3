...
----------------------------------------
  ...
  Files:
    ...
    * cyfxusbi2cregmode.h : Constant definitions for the USB I2C application.
    ...
    * cyfxusbi2cregmode.c : Main C source file that implements the USB I2C application
      example.
