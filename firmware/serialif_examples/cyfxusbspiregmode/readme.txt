...
USB SPI (REGISTER MODE) LOOPBACK EXAMPLE
----------------------------------------

  This example illustrates the use of the FX3 firmware APIs to implement
  a USB SPI flash programming example.
  ...
  Files:
    ...
    * cyfxusbspiregmode.h : Constant definitions for the USB SPI application.
    ...
    * cyfxusbspiregmode.c : Main C source file that implements the USB SPI application
      example.
